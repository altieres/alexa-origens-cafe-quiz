...
const GAME_LENGTH = 5;
const SKILL_NAME = 'Origens Café';
const FALLBACK_MESSAGE = `A skill ${SKILL_NAME} não pode te ajudar com isso. Ela pode fazer perguntas sobre o universo do Café se você me pedir para jogar Origens Café. Como posso ajudar?`;
